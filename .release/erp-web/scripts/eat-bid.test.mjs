...
test('rejects unsafe, malformed, and upstream-error XML', () => {
  ...
  assert.deepEqual(
    parseEatBidXml('<response><header><resultCode>00</resultCode></header><body><items/><pageNo>2</pageNo><numOfRows>20</numOfRows><totalCount>20</totalCount></body></response>').items,
    [],
  );
});
